...
// Moved verbatim from apps/web/src/lib/case-schema.ts (SP-1b Task 2) so that
// @docjob/core (which is not allowed to import from apps/web) can validate
// case input without depending on the web app. apps/web/src/lib/case-schema.ts
// now just re-exports this module so existing web imports keep working.
